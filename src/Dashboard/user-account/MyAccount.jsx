                    ...
                    <div className='pb-[50px] px-[30px] rounded-md'>
                        <div className='flex items-center justify-center'>
                            ...
                            <div className='mt-[50px] md:mt-[100px]'>
                                ...
                                className='w-full bg-[#181A1E] mb-3 p-3 text-[16px] leading-7 rounded-md text-white'>LogOut</button>
                                <button className='w-full bg-red-600 p-3 mt-2 text-[16px] leading-7 rounded-md text-white'>Delete account </button>
        
                            </div>
        
                    </div>
                        <div className='md:col-span-2 mx:px-[30px]'>
                            <div>
                                ...
                                className={`${tab==='settings' && 'bg-primaryColor text-white font-normal'} p-2 px-5 rounded-md text-headingColor font-semibold text-[16px] 
