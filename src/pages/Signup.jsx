                    ...
                    text-[16px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer" required/>     
                        ...
                        <div className='mb-5 flex items-center justify-between '>
                            <label  className='text-textColor font-semibold text-[16px] leading-7'>
                                Are you a :
                                <select name="role" value={formData.role} onChange={handleInputChange} id="" className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
                            ...
                            <label  className='text-textColor font-semibold text-[16px] leading-7'>
                                    Gender:
                                <select name="gender" value={formData.gender} onChange={handleInputChange} id="" className='text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none'>
