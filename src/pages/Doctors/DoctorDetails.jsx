...
const DoctorDetails = () => {
    const [teb,setTab]=useState('about');
    const {id} =useParams();
    const {data:doctor ,
            loading ,
            error
            ...
            <div className='grid md:grid-cols-3 gap-[50px]'>
                    <div className='md:col-span-2'>
                        <div className='flex items-center gap-5'>
                            ...
                            <div>
                                ...
                                <div className='flex items-center gap-[6px]'>
                                    ...
                                    lg:leading-7 font-semibold text-textColor  font[400]'>({totalRating})</span>
                                </div>
                        ...
                        <div className='mt-[50px] border-b border-solid border-[#0066ff34]'>
                            <button
                                onClick={()=> setTab("about")} className={`${teb==='about' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}>About </button>
                            <button
                                onClick={()=> setTab("feedback")}  className={`${teb==='feedback' && 'border-b border-solid border-primaryColor'} py-2 px-5 mr-5 text-[16px] leading-7 text-headingColor font-semibold`}>Feedback </button>
                        </div>
